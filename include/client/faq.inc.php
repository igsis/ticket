...
<div id="breadcrumbs">
    <a href="index.php">Todas Categorias</a>
...
<div class="article-meta"><span class="faded"><b>Tópicos de Ajuda:</b></span>
    <?php echo ($topics=$faq->getHelpTopics())?implode(', ',$topics):' '; ?>
</div>
</p>
<hr>
<div class="faded">&nbsp;Última Atualização <?php echo Format::db_daydatetime($category->getUpdateDate()); ?></div>
