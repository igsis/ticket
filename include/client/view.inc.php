...
<div id="msg_info">
    ...
    <strong>Procurando seus outros tickets?</strong></br>
    <a href="<?php echo ROOT_PATH; ?>login.php?e=<?php
        echo urlencode($thisclient->getEmail());
        ?>" style="text-decoration:underline">Entrar</a> ou
    <a href="account.php?do=create" style="text-decoration:underline"> criar uma conta</a>
    para a melhor experiência em nosso help desk.</div>
    ...
    <tr>
        <td width="50%">
            <table class="infoTable" cellspacing="1" cellpadding="3" width="100%" border="0">
                ...
                <tr>
                    <th>Data de Criação:</th> //Create Date
...
<br>
<div class="subject">Assunto: <strong><?php echo Format::htmlchars($ticket->getSubject()); ?></strong></div>
<div id="ticketThread">
<?php
...
<form id="reply" action="tickets.php?id=<?php echo $ticket->getId(); ?>#reply" name="reply" method="post" enctype="multipart/form-data">
    ...
    <p style="padding-left:165px;">
        ...
        <input type="reset" value="Redefinr">
