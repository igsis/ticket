...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!$this->tabs) {
            $this->tabs=array();
            $this->tabs['dashboard'] = array('desc'=>'Painel','href'=>'dashboard.php','title'=>'Staff Dashboard');
            $this->tabs['users'] = array('desc' => 'Usuários', 'href' => 'users.php', 'title' => 'User Directory');
            $this->tabs['tickets'] = array('desc'=>'Tickets','href'=>'tickets.php','title'=>'Ticket Queue');
            $this->tabs['kbase'] = array('desc'=>'Conhecimento','href'=>'kb.php','title'=>'Knowledgebase');
            if (count($this->getRegisteredApps()))
                $this->tabs['apps']=array('desc'=>'Aplicações','href'=>'apps.php','title'=>'Applications');
        }
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                case 'tickets':
                    ...
                    break;
                case 'dashboard':
                    $subnav[]=array('desc'=>'Painel','href'=>'dashboard.php','iconclass'=>'logs');
                    $subnav[]=array('desc'=>'Membros da Equipe','href'=>'directory.php','iconclass'=>'teams');
                    $subnav[]=array('desc'=>'Meu Perfil','href'=>'profile.php','iconclass'=>'users');
                    break;
                case 'users':
                    $subnav[] = array('desc' => 'Diretório de Usuário', 'href' => 'users.php', 'iconclass' => 'teams');
                    $subnav[] = array('desc' => 'Organização', 'href' => 'orgs.php', 'iconclass' => 'departments');
                    break;
                case 'kbase':
                    ...
                    if($staff) {
                        ...
                        if($staff->canManageCannedResponses())
                            $subnav[]=array('desc'=>'Respostas Prontas','href'=>'canned.php','iconclass'=>'canned');
                    }
                   break;
                case 'apps':
...
class AdminNav extends StaffNav{
    ...
    function getTabs(){
        ...
        if(!$this->tabs){
            ...
            $tabs=array();
            $tabs['dashboard']=array('desc'=>'Painel','href'=>'logs.php','title'=>'Admin Dashboard');
            $tabs['settings']=array('desc'=>'Configurações','href'=>'settings.php','title'=>'System Settings');
            $tabs['manage']=array('desc'=>'Gerenciamento','href'=>'helptopics.php','title'=>'Manage Options');
            $tabs['emails']=array('desc'=>'E-mails','href'=>'emails.php','title'=>'Email Settings');
            $tabs['staff']=array('desc'=>'Funcionário','href'=>'staff.php','title'=>'Manage Staff');
            if (count($this->getRegisteredApps()))
                $tabs['apps']=array('desc'=>'Aplicações','href'=>'apps.php','title'=>'Applications');
            $this->tabs=$tabs;
        }
    ...
    function getSubMenus(){
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                case 'dashboard':
                    $subnav[]=array('desc'=>'Logs do Sistema','href'=>'logs.php','iconclass'=>'logs');
                    $subnav[]=array('desc'=>'Informação','href'=>'system.php','iconclass'=>'preferences');
                    break;
                case 'settings':
                    $subnav[]=array('desc'=>'Empresa','href'=>'settings.php?t=pages','iconclass'=>'pages');
                    ...
                    $subnav[]=array('desc'=>'Acesso','href'=>'settings.php?t=access','iconclass'=>'users');
                    $subnav[]=array('desc'=>'Base de Conhecimento','href'=>'settings.php?t=kb','iconclass'=>'kb-settings');
                    $subnav[]=array('desc'=>'Auto-Resposta','href'=>'settings.php?t=autoresp','iconclass'=>'email-autoresponders');
                    $subnav[]=array('desc'=>'Alertas & Avisos','href'=>'settings.php?t=alerts','iconclass'=>'alert-settings');
                    break;
                case 'manage':
                    $subnav[]=array('desc'=>'Tópicos de Ajuda','href'=>'helptopics.php','iconclass'=>'helpTopics');
                    $subnav[]=array('desc'=>'Filtros de Ticket','href'=>'filters.php',
                                        'title'=>'Ticket&nbsp;Filters','iconclass'=>'ticketFilters');
                    $subnav[]=array('desc'=>'Planos de SLA','href'=>'slas.php','iconclass'=>'sla');
                    $subnav[]=array('desc'=>'Chave de API','href'=>'apikeys.php','iconclass'=>'api');
                    $subnav[]=array('desc'=>'Páginas', 'href'=>'pages.php','title'=>'Pages','iconclass'=>'pages');
                    $subnav[]=array('desc'=>'Formulários','href'=>'forms.php','iconclass'=>'forms');
                ...
                case 'emails':
                    ...
                    $subnav[]=array('desc'=>'Lista de Banidos','href'=>'banlist.php',
                                        'title'=>'Banned&nbsp;Emails','iconclass'=>'emailDiagnostic');
                    $subnav[]=array('desc'=>'Modelos','href'=>'templates.php','title'=>'Email Templates','iconclass'=>'emailTemplates');
                    $subnav[]=array('desc'=>'Diagnóstico','href'=>'emailtest.php', 'title'=>'Email Diagnostic', 'iconclass'=>'emailDiagnostic');
                    break;
                case 'staff':
                    $subnav[]=array('desc'=>'Membros','href'=>'staff.php','iconclass'=>'users');
