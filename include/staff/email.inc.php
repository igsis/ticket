...
if($email && $_REQUEST['a']!='add'){
    ...
    if($info['userpass'])
        $passwdtxt='Para alterar a senha digite a nova senha acima.';
    ...
    <thead>
        <tr>
            <th colspan="2">
                ...
                <em><strong>Configurações de E-mail</strong></em>
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            <th colspan="2">
                <em><strong>Configuração de Novo Ticket</strong></em>
            </th>
        </tr>
        <tr>
            <td width="180">
        ...
        <tr>
            ...
            <td>
                ...
                <strong>Desativar</strong> para este endereço de E-mail
                </label>
        ...
        <tr>
            <th colspan="2">
                <em><strong>Informações de Login de E-mail</strong>&nbsp;<i class="help-tip icon-question-sign" href="#login_information"></i></em>
            </th>
        </tr>
        <tr>
            <td width="180">
        ...
        <tr>
            <th colspan="2">
                <em><strong>Busca de E-mail via IMAP ou POP</strong>&nbsp;<i class="help-tip icon-question-sign" href="#mail_account"></i>&nbsp;<font class="error">&nbsp;<?php echo $errors['mail']; ?></font></em>
            </th>
        </tr>
        <tr>
            <td>Status</td>
            <td>
                <label><input type="radio" name="mail_active"  value="1"   <?php echo $info['mail_active']?'checked="checked"':''; ?> />&nbsp;Ativado</label>
                &nbsp;&nbsp;
                <label><input type="radio" name="mail_active"  value="0"   <?php echo !$info['mail_active']?'checked="checked"':''; ?> />&nbsp;Desativado</label>
        ...
        <tr><td>Protocolo de Caixa de Correio</td>
            <td>
		<span>
			<select name="mail_proto">
			    <option value=''>&mdash; Selecione Protocolo &mdash;</option>
<?php
...
<?php } ?>
        ...
        <tr><td>Frequência de Busca</td>
            <td>
		<span>
			<input type="text" name="mail_fetchfreq" size=4 value="<?php echo $info['mail_fetchfreq']?$info['mail_fetchfreq']:''; ?>"> minutos
			<i class="help-tip icon-question-sign" href="#fetch_frequency"></i>
			&nbsp;<font class="error">&nbsp;<?php echo $errors['mail_fetchfreq']; ?></font>
		</span>
            </td>
        </tr>
        <tr><td>Busca por E-mails</td>
            <td>
		<span>
			<input type="text" name="mail_fetchmax" size=4 value="<?php echo $info['mail_fetchmax']?$info['mail_fetchmax']:''; ?>"> e-mails
			<i class="help-tip icon-question-sign" href="#emails_per_fetch"></i>
			&nbsp;<font class="error">&nbsp;<?php echo $errors['mail_fetchmax']; ?></font>
		</span>
            </td>
        </tr>
        <tr><td valign="top">E-mails Buscados</td>
             <td>
                <label><input type="radio" name="postfetch" value="archive" <?php echo ($info['postfetch']=='archive')? 'checked="checked"': ''; ?> >
                 Mover para pasta: <input type="text" name="mail_archivefolder" size="20" value="<?php echo $info['mail_archivefolder']; ?>"/></label>
        ...
        <tr>
            <th colspan="2">
                <em><strong>Configurações de SMTP</strong>&nbsp;<i class="help-tip icon-question-sign" href="#smtp_settings"></i>&nbsp;<font class="error">&nbsp;<?php echo $errors['smtp']; ?></font></em>
            </th>
        </tr>
        <tr><td>Status</td>
            <td>
                <label><input type="radio" name="smtp_active"  value="1"   <?php echo $info['smtp_active']?'checked':''; ?> />&nbsp;Ativado</label>
                &nbsp;
                <label><input type="radio" name="smtp_active"  value="0"   <?php echo !$info['smtp_active']?'checked':''; ?> />&nbsp;Desativado</label>
        ...
        <tr>
            ...
            <td>
                ...
                Permitir para este Endereço de E-mail</label>
                <i class="help-tip icon-question-sign" href="#header_spoofing"></i>
            </td>
        </tr>
        <tr>
            <th colspan="2">
                <em><strong>Notas Interna</strong>: Notas do Admin. &nbsp;<span class="error">&nbsp;<?php echo $errors['notes']; ?></span></em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
