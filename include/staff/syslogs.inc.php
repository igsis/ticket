...
if($res && ($num=db_num_rows($res)))
    ...
    $showing='Nenhum registro  !';
?>

<h2>Logs do Sistema&nbsp;<i class="help-tip icon-question-sign" href="#system_logs"></i></h2>
<div id='filter' >
 <form action="logs.php" method="get">
    <div style="padding-left:2px;">
        <b>Intervalo de Data</b>&nbsp;<i class="help-tip icon-question-sign" href="#date_span"></i>
        &nbsp;De&nbsp;<input class="dp" id="sd" size=15 name="startDate" value="<?php echo Format::htmlchars($_REQUEST['startDate']); ?>" autocomplete=OFF>
            &nbsp;&nbsp; até &nbsp;&nbsp;
            <input class="dp" id="ed" size=15 name="endDate" value="<?php echo Format::htmlchars($_REQUEST['endDate']); ?>" autocomplete=OFF>
            &nbsp;&nbsp;
            &nbsp;Tipo&nbsp;<i class="help-tip icon-question-sign" href="#type"></i>
            <select name='type'>
                <option value="" selected>Todos</option>
                <option value="Error" <?php echo ($type=='Error')?'selected="selected"':''; ?>>Erros</option>
                <option value="Warning" <?php echo ($type=='Warning')?'selected="selected"':''; ?>>Alertas</option>
...
<?php csrf_token(); ?>
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>        
            <th width="320"><a <?php echo $title_sort; ?> href="logs.php?<?php echo $qstr; ?>&sort=title">Título</a></th>
            <th width="100"><a  <?php echo $type_sort; ?> href="logs.php?<?php echo $qstr; ?>&sort=type">Tipo</a></th>
            <th width="200" nowrap><a  <?php echo $date_sort; ?>href="logs.php?<?php echo $qstr; ?>&sort=date">Data</a></th>
            <th width="120"><a  <?php echo $ip_sort; ?> href="logs.php?<?php echo $qstr; ?>&sort=ip">Endereço IP</a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<p class="centered" id="actions">
    <input class="button" type="submit" name="delete" value="Apagar Entradas Selecionadas">
</p>
<?php
endif;
?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Tem certeza que deseja EXCLUIR eventos selecionados?</strong></font>
        <br><br>Eventos excluídos não podem ser recuperados.
    </p>
