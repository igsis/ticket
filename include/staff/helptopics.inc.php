...
if($res && ($num=db_num_rows($res)))
    $showing="Mostrando $num topicos de ajuda";
else
    $showing='Nenhum tópico de ajuda encontrado!';
...
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="helptopics.php?a=add" class="Icon newHelpTopic">Adicionar Tópico de Ajuda</a></b></div>
<div class="clear"></div>
...
<?php foreach (OsticketConfig::allTopicSortModes() as $i=>$m)
    ...
    <thead>
        <tr>
            ...
            <th style="padding-left:4px;vertical-align:middle" width="360">Tópico de Ajuda</th>
            <th style="padding-left:4px;vertical-align:middle" width="80">Status</th>
            <th style="padding-left:4px;vertical-align:middle" width="100">Tipo</th>
            <th style="padding-left:4px;vertical-align:middle" width="100">Prioridade</th>
            <th style="padding-left:4px;vertical-align:middle" width="160">Departamento</th>
            <th style="padding-left:4px;vertical-align:middle" width="150" nowrap>Última Atualização</th>
        </tr>
    </thead>
...
<a href="helptopics.php?id=<?php echo $row['topic_id']; ?>"><?php echo $row['name']; ?></a>&nbsp;</td>
                ...
                <td><?php echo $row['ispublic']?'Público':'<b>Privado</b>'; ?></td>
    ...
    <tfoot>
     <tr>
        <td colspan="7">
            ...
            <?php }else{
                echo 'Nenhum tópico de ajuda encontrado';
            } ?>
        </td>
     </tr>
    </tfoot>
...
<?php } ?>
    <button class="button" type="submit" name="enable" value="Enable" >Ativar</button>
    <button class="button" type="submit" name="disable" value="Disable">Desativar</button>
    <button class="button" type="submit" name="delete" value="Delete">Excluir</button>
</p>
<?php
endif;
?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        Tem certeza que deseja <b>ativar</b> os tópicos de ajuda selecionados?
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        Tem certeza que deseja <b>desativar</b> os tópicos de ajuda selecionados?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>ATem certeza que deseja EXCLUIR os tópicos de ajuda selecionados?</strong></font>
        <br><br>Tópicos de ajuda excluídos não podem ser recuperados.
    </p>
