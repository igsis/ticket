...
<div id='basic_search'>
    ...
    <table>
        <tr>
            ...
            <td>&nbsp;&nbsp;<a href="#" id="go-advanced">[avançado]</a>&nbsp;<i class="help-tip icon-question-sign" href="#advanced"></i></td>
        </tr>
    </table>
    </form>
</div>
...
<?php csrf_token(); ?>
 <a class="refresh" href="<?php echo Format::htmlchars($_SERVER['REQUEST_URI']); ?>">Atualizar</a>
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="2" width="940">
        ...
        <tr>
	        ...
	        <th width="70">
                <a  <?php echo $date_sort; ?> href="tickets.php?sort=date&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
                    title="Sort By Date <?php echo $negorder; ?>">Data</a></th>
	        <th width="280">
                 <a <?php echo $subj_sort; ?> href="tickets.php?sort=subj&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
                    title="Sort By Subject <?php echo $negorder; ?>">Assunto</a></th>
            <th width="170">
                ...
                if(!strcasecmp($status,'closed')) { ?>
                    <th width="150">
                        <a <?php echo $staff_sort; ?> href="tickets.php?sort=staff&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
                            title="Sort By Closing Staff Name <?php echo $negorder; ?>">Fechado Por</a></th>
                <?php
                } else { //assigned to ?>
                    <th width="150">
                        <a <?php echo $assignee_sort; ?> href="tickets.php?sort=assignee&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
                            title="Sort By Assignee <?php echo $negorder;?>">Atribuído a</a></th>
                <?php
                }
            } else { ?>
                <th width="150">
                    <a <?php echo $dept_sort; ?> href="tickets.php?sort=dept&order=<?php echo $negorder;?><?php echo $qstr; ?>"
                        title="Sort By Department <?php echo $negorder; ?>">Departamento</a></th>
            <?php
            } ?>
        </tr>
     </thead>
    ...
    <tfoot>
     <tr>
        <td colspan="7">
            ...
            <?php }else{
                echo '<i>';
                echo $ferror?Format::htmlchars($ferror):'Consulta retornou 0 resultados.';
                echo '</i>';
            } ?>
        </td>
     </tr>
    ...
    if($num>0){ //if we actually had any tickets returned.
        echo '<div>&nbsp;Página:'.$pageNav->getPageLinks().'&nbsp;';
        echo '<a class="export-csv no-pjax" href="?a=export&h='
            .$hash.'&status='.$_REQUEST['status'] .'">Exportar</a>&nbsp;<i class="help-tip icon-question-sign" href="#export"></i></div>';
    ?>
        <?php
         if($thisstaff->canManageTickets()) { ?>
           <p class="centered" id="actions">
            ...
            switch (strtolower($status)) {
                ...
                case 'assigned':
                    ?>
                    <input class="button" type="submit" name="mark_overdue" value="Atrasar" >
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="close-confirm">
        Tem certeza que deseja <b>fechar</b> os tickets selecionados?
    </p>
    <p class="confirm-action" style="display:none;" id="reopen-confirm">
        Tem certeza que deseja < <b>reabri</b> os tickets selecionados?
    </p>
    <p class="confirm-action" style="display:none;" id="mark_overdue-confirm">
        Tem certeza que deseja sinalizar os tickets selecionadas como <font color="red"><b>atrasado</b></font>?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Tem certeza que deseja excluir os bilhetes selecionados?</strong></font>
...
<div class="dialog" style="display:none;" id="advanced-search">
    <h3>Pesquisa Avançada de Ticket</h3>
    <a class="close" href=""><i class="icon-remove-circle"></i></a>
    <form action="tickets.php" method="post" id="search" name="search">
        ...
        <fieldset>
            ...
            <select id="deptId" name="deptId">
                <option value="">&mdash; Todos Departamentos &mdash;</option>
                <?php
        ...
        <fieldset>
            <label for="topicId">Tópico de Ajuda:</label>
            <select id="topicId" name="topicId">
                <option value="" selected >&mdash; Todos Tópicos de Ajuda &mdash;</option>
                <?php
