...
//echo $query;
?>
<h2>Membros da Equipe&nbsp;<i class="help-tip icon-question-sign" href="#staff_members"></i></h2>
<div style="width:700px; float:left;">
    <form action="directory.php" method="GET" name="filter">
       <input type="text" name="q" value="<?php echo Format::htmlchars($_REQUEST['q']); ?>" >
        ...
        &nbsp;&nbsp;
        <input type="submit" name="submit" value="Filtrar"/>&nbsp;&nbsp;<i class="help-tip icon-question-sign" href="#apply_filtering_criteria"></i>
    </form>
 </div>
<div class="clear"></div>
<?php
...
if($res && ($num=db_num_rows($res)))        
    ...
    $showing='Nenhum membro encontrado!';
?>
<table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            ...
            <th width="180"><a  <?php echo $email_sort; ?>href="directory.php?<?php echo $qstr; ?>&sort=email">Endereço de E-mail</a></th>
            <th width="120"><a <?php echo $phone_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=phone">Telefone Res</a></th>
            <th width="80"><a <?php echo $ext_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=ext">Recado</a></th>
