...
if($res && ($num=db_num_rows($res)))
    $showing="Mostrando 1-$num de $num equipes";
else
    $showing='Nenhuma equipe encontrada!';
...
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="teams.php?a=add" class="Icon newteam">Adicionar Equipe</a></b></div>
<div class="clear"></div>
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            ...
            <th width="200"><a  <?php echo $lead_sort; ?> href="teams.php?<?php echo $qstr; ?>&sort=lead">Líder</a></th>
            <th width="100"><a  <?php echo $created_sort; ?> href="teams.php?<?php echo $qstr; ?>&sort=created">Criado</a></th>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        Tem certeza que deseja <b>ativar</b> equipes selecionada?
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        Tem certeza que deseja <b>desativar</b> equipes selecionada?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Tem certeza que deseja EXCLUIR equipes selecionada?</strong></font>
        <br><br>Equipe excluída não podem ser recuperada.
    </p>
