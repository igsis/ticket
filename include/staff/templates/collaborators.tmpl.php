...
<form method="post" class="collaborators" action="#tickets/<?php echo $ticket->getId(); ?>/collaborators">
    ...
    <div><a class="collaborator"
        href="#tickets/<?php echo $ticket->getId(); ?>/add-collaborator" >Adicionar Novo Colaborador</a></div>
    <div id="savewarning" style="display:none; padding-top:2px;"><p id="msg_warning">Você precisa salvar as alterações.</p></div>
    <p class="full-width">
