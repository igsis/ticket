...
if($res && ($num=db_num_rows($res)))
    ...
    $showing .= "Esta organização não tem nenhum usuários ainda";

?>
<div style="width:700px; float:left;"><b><?php echo $showing; ?></b></div>
<div style="float:right;text-align:right;padding-right:5px;">
    <b><a href="#orgs/<?php echo $org->getId(); ?>/add-user" class="Icon newstaff add-user">Adicionar Usuário</a></b>
    |
    <b><a href="#orgs/<?php echo $org->getId(); ?>/import-users" class="add-user">
    <i class="icon-cloud-upload icon-large"></i> Importar</a></b>
</div>
<div class="clear"></div>
<br/>
<?php
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="remove-users-confirm">
        Tem certeza que deseja <b>REMOVER</b> usuários selecionados da organização <strong><?php
        echo $org->getName(); ?></strong>?
    </p>
