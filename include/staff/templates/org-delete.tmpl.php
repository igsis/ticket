...
if (!$info['title'])
    $info['title'] = 'Excluir '.Format::htmlchars($org->getName());

$info['warn'] = 'Organizações excluídas não podem ser recuperadas';
...
?>
    ...
    <div>&nbsp;<strong><?php echo sprintf('%d %s', $users, $users>1 ? 'users' : 'user');
        ?> atribuído a essa organização será órfão.</strong></div>
    <?php
    } ?>
    <hr>
