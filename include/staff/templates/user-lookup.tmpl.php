...
<div><p id="msg_info"><i class="icon-info-sign"></i>&nbsp; Pesquisar usuários existentes ou adicionar um novo usuário..</p></div>
<div style="margin-bottom:10px;">
    <input type="text" class="search-input" style="width:100%;"
    placeholder="Pesquisar por e-mail, telefone ou nome" id="user-search"
...
<form method="post" class="user" action="<?php echo $info['action'] ?  $info['action'] : '#users/lookup'; ?>">
    ...
    <a class="action-button pull-right" style="overflow:inherit"
        id="unselect-user"  href="#"><i class="icon-remove"></i> Adicionar Novo Usuário</a>
<?php if ($user) { ?>
...
<form method="post" class="user" action="<?php echo $info['action'] ?: '#users/lookup/form'; ?>">
    ...
    <?php
        ...
        $form->render(true, 'Criar Novo Usuário'); ?>
    </table>
    <hr>
    <p class="full-width">
        <span class="buttons" style="float:left">
