...
<div><p id="msg_info"><i class="icon-info-sign"></i>&nbsp;Preencha o formulário abaixo para criar uma conta de usuário para <b><?php echo
...
<div id="user-registration" style="display:block; margin:5px;">
    <form method="post" class="user"
        ...
        <tbody>
            <tr>
                <th colspan="2">
                    <em><strong>Conta de Usuário</strong></em>
                </th>
            </tr>
            <tr>
                <td>Fontes de Autenticação:</td>
                <td>
            <select name="backend" id="backend-selection" onchange="javascript:
                ...
                ">
                <option value="">&mdash; Usar qualquer backend disponível &mdash;</option>
            ...
            <tr>
                ...
                <td>
                  <input type="checkbox" id="sendemail" name="sendemail" value="1"
                    ...
                    Enviar e-mail de ativação para <?php echo $user->getEmail(); ?>.
                </td>
            </tr>
        </tbody>
        <tbody id="password"
            ...
            <tr>
                ...
                <td colspan=2>
                    <input type="checkbox" name="pwreset-flag" value="1" <?php
                        echo $info['pwreset-flag'] ?  'checked="checked"' : ''; ?>> Exigir alteração de senha no login
                    <br/>
                    <input type="checkbox" name="forbid-pwreset-flag" value="1" <?php
                        echo $info['forbid-pwreset-flag'] ?  'checked="checked"' : ''; ?>> Usuário não pode alterar a senha
                </td>
            </tr>
        </tbody>
        <tbody>
