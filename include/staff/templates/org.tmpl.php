...
<div id="org-profile" style="display:<?php echo $forms ? 'none' : 'block'; ?>;margin:5px;">
    ...
    <a class="action-button pull-right user-action" style="overflow:inherit"
        href="#users/<?php echo $user->getId(); ?>/org/<?php echo $org->getId(); ?>" ><i class="icon-user"></i> Alterar</a>
    <a class="action-button pull-right" href="orgs.php?id=<?php echo $org->getId(); ?>"><i class="icon-share"></i> Gerenciar</a>
    <?php
    } ?>
...
?>
    ...
    <div class="clear"></div>
    <hr>
    <div class="faded">Última Atualização<b><?php echo Format::db_datetime($org->getUpdateDate()); ?> </b></div>
</div>
...
<form method="post" class="org" action="<?php echo $action; ?>">
    ...
    <p class="full-width">
        <span class="buttons" style="float:left">
            <input type="reset" value="Redefnir">
