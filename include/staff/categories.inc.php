...
if($res && ($num=db_num_rows($res)))
    ...
    $showing='Nenhuma categoria de FAQ encontrada!';

?>
<div style="width:700px;padding-top:5px; float:left;">
 <h2>Categorias de FAQ&nbsp;<i class="help-tip icon-question-sign" href="#faq_categories"></i></h2>
 </div>
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="categories.php?a=add" class="Icon newCategory">Adicionar Categoria</a></b></div>
<div class="clear"></div>
    ...
    <?php
        ...
        if($res && db_num_rows($res)):
            ...
            <tr id="<?php echo $row['category_id']; ?>">
                ...
                <td><?php echo $row['ispublic']?'<b>Público</b>':'Interno'; ?></td>
    ...
    <tfoot>
     <tr>
        <td colspan="5">
            ...
            <?php }else{
                echo 'Nenhuma Categoria de FAQ encontrada.';
            } ?>
        </td>
     </tr>
    </tfoot>
...
<p class="centered" id="actions">
    ...
    <input class="button" type="submit" name="make_private" value="Tornar Interno">
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="make_public-confirm">
        Tem certeza que deseja tornar as categorias selecionadas <b>pública</b>?
    </p>
    <p class="confirm-action" style="display:none;" id="make_private-confirm">
        Tem certeza que deseja tornar as categorias selecionadas  <b>privada</b> (interna)?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Tem certeza que deseja EXCLUIR as categorias selecionadas?</strong></font>
