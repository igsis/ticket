...
if($res && ($num=db_num_rows($res)))
    ...
    $showing='Nenhum e-mail de ajuda encontrado!';
...
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="emails.php?a=add" class="Icon newEmail">Adicionar E-mail</a></b></div>
<div class="clear"></div>
<form action="emails.php" method="POST" name="emails">
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="7">&nbsp;</th>        
            <th width="400"><a <?php echo $email_sort; ?> href="emails.php?<?php echo $qstr; ?>&sort=email">E-mail</a></th>
            ...
            <th width="110" nowrap><a  <?php echo $created_sort; ?>href="emails.php?<?php echo $qstr; ?>&sort=created">Criado Em</a></th>
    ...
    <tfoot>
     <tr>
        <td colspan="6">
            ...
            <?php }else{
                echo 'Nenhum e-mail de ajuda encontrado';
            } ?>
        </td>
     </tr>
    </tfoot>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Tem certeza que deseja EXCLUIR e-mails selecionados?</strong></font>
        <br><br>E-mails excluídos não podem ser recuperados.
    </p>
