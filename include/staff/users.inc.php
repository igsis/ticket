...
<div style="width:700px; float:left;">
 ...
 <div style="float:right;text-align:right;padding-right:5px;">
    <b><a href="#users/add" class="Icon newstaff popup-dialog">Adicionar Usuário</a></b>
    |
    <b><a href="#users/import" class="popup-dialog"><i class="icon-cloud-upload icon-large"></i> Importar</a></b>
</div>
<div class="clear"></div>
<?php
$showing = $search ? 'Resultados da Pesquisa: ' : '';
$res = db_query($query);
if($res && ($num=db_num_rows($res)))
    $showing .= $pageNav->showing();
else
    $showing .= 'Nenhum usuário encontrado!';
?>
<form action="users.php" method="POST" name="staff" >
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="350"><a <?php echo $name_sort; ?> href="users.php?<?php echo $qstr; ?>&sort=name">Nome</a></th>
            <th width="250"><a  <?php echo $status_sort; ?> href="users.php?<?php echo $qstr; ?>&sort=status">Status</a></th>
            <th width="100"><a <?php echo $create_sort; ?> href="users.php?<?php echo $qstr; ?>&sort=create">Criado</a></th>
            <th width="145"><a <?php echo $update_sort; ?> href="users.php?<?php echo $qstr; ?>&sort=update">Atualizado</a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
if($res && $num): //Show options..
    echo sprintf('<div>&nbsp;Página: %s &nbsp; <a class="no-pjax"
            href="users.php?a=export&qh=%s">Exportar</a></div>',
