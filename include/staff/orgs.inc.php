...
<div style="width:700px; float:left;">
 ...
 <div style="float:right;text-align:right;padding-right:5px;">
    <b><a href="#orgs/add" class="Icon newDepartment add-org">Adicionar Organização</a></b></div>
<div class="clear"></div>
<?php
$showing = $search ? 'Resultado da Pesquisa: ' : '';
$res = db_query($query);
if($res && ($num=db_num_rows($res)))
    $showing .= $pageNav->showing();
else

    $showing .= 'Nenhuma organização encontrada!';
?>
<form action="orgs.php" method="POST" name="staff" >
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            <th width="400"><a <?php echo $name_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=name">Nome</a></th>
            <th width="100"><a <?php echo $users_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=users">Usuários</th>
            <th width="150"><a <?php echo $create_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=create">Criado</a></th>
            <th width="145"><a <?php echo $update_sort; ?> href="orgs.php?<?php echo $qstr; ?>&sort=update">Atualizado</a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
if($res && $num): //Show options..
    echo sprintf('<div>&nbsp;Página: %s &nbsp; <a class="no-pjax"
            href="orgs.php?a=export&qh=%s">Exportar</a></div>',
