...
<h2><span>Modelo de Email &nbsp;/&nbsp; <span><a href="templates.php?tpl_id=<?php echo $tpl_id; ?>"><?php echo $name; ?></a>
    <input type="hidden" name="a" value="manage">
    <input type="hidden" name="tpl_id" value="<?php echo $tpl_id; ?>">
<div class="pull-right">
    <span style="font-size:10pt">Visualizando:</span>
    <select id="tpl_options" name="id" style="width:300px;">
        <option value="">&mdash; Selecionar Configuração de Grupo&mdash;</option>
        <?php
...
<div style="padding-bottom:3px;" class="faded"><strong>Assunto do Email e Corpo:</strong></div>
<div id="toolbar"></div>
...
<p style="text-align:center">
    ...
    <input class="button" type="reset" name="reset" value="Redefinir" onclick="javascript:
        setTimeout('location.reload()', 25);" />
    <input class="button" type="button" name="cancel" value="Cancelar"
