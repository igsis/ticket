...
if($res && ($num=db_num_rows($res)))
    $showing="Mostrando 1-$num de $num departamentos";
else
    $showing='Nenhum departamento encontrado!';
...
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="departments.php?a=add" class="Icon newDepartment">Adicionar Departamento</a></b></div>
<div class="clear"></div>
 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    ...
    <thead>
        <tr>
            ...
            <th width="300"><a  <?php echo $email_sort; ?> href="departments.php?<?php echo $qstr; ?>&sort=email">Endereço de Email</a></th>
            <th width="200"><a  <?php echo $manager_sort; ?> href="departments.php?<?php echo $qstr; ?>&sort=manager">Gerente de Dept. </a></th>
        </tr>
    </thead>
    <tbody>
    <?php
...
<p class="centered" id="actions">
    <input class="button" type="submit" name="make_public" value="Tornar Público" >
    <input class="button" type="submit" name="make_private" value="Tornar Privado" >
    <input class="button" type="submit" name="delete" value="Excluir Dept(s)" >
</p>
<?php
endif; 
?>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="make_public-confirm">
        Tem certeza que deseja tornar os departamentos selecionados <b>público</b>?
    </p>
    <p class="confirm-action" style="display:none;" id="make_private-confirm">
        Tem certeza que deseja tornar os departamentos selecionados <b>privado</b>?
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong>Tem certeza que deseja EXCLUIR os departamentos selecionados?</strong></font>
        <br><br>Departamentos excluídos não podem ser recuperados.
    </p>
