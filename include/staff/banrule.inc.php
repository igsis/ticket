...
if($rule && $_REQUEST['a']!='add'){
    ...
    $title='Adicionar E-mail a Lista de Banidos';
    $action='add';
    ...
    <thead>
        <tr>
            <th colspan="2">
                ...
                <em>Endereço de e-mail válido obrigatório.</em>
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            <th colspan="2">
                <em><strong>Notas Internas</strong>: Notas do Admin&nbsp;</em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
